...
@synthesize longitudeOfTargetedPoint;
@synthesize latitudeOfTargetedPoint;
@synthesize latLabel;
@synthesize lonLabel;
...
// Caculate the angle between the north and the direction to observed campus.
       ...
       didFailWithError:(NSError *)error
{
    ...
    if ([error code] == kCLErrorDenied) {
        errorMsg = @"visited denied";
    }
    if ([error code] == kCLErrorLocationUnknown) {
        errorMsg = @"get information failed";
    }
